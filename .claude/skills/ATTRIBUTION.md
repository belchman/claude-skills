...
| --- | --- | --- | --- |
| `audit-claude-overhead` | Built locally; methodology from [@mnilax thread, 2026](https://x.com/mnilax/status/2050261839653556522) | n/a (original work; methodology cited) | The 9 token-waste patterns and percentages come from @mnilax's 90-day instrumented study; cited inline in the SKILL.md and patterns.md. |
